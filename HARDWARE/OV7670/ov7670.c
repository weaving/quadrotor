...
u8 OV7670_Init(void)
{
  ...
  RCC->AHB1ENR|=1<<2;		//先使能外设PORTC时钟
	...
	GPIO_Set(GPIOD,PIN9,GPIO_Mode_IN,0,0,GPIO_PUPD_PD); 			//PF9设置为下拉输入 
	GPIOD->ODR|=1<<9; 
	...
	GPIO_Set(GPIOB,PIN14|PIN13,GPIO_Mode_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU); //PC1 3设置输出
//	GPIO_Set(GPIOD,PIN0|PIN1|PIN2|PIN3|PIN4|PIN5|PIN6|PIN7,GPIO_MODE_IN,0,0,GPIO_PUPD_PD); 			//PF0 7设置为下拉输入 	
	
	GPIO_InitStructure.GPIO_Pin  = PIN0|PIN1|PIN2|PIN3|PIN4|PIN5|PIN6|PIN7; 	//
  ...
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
	...
	GPIO_Set(GPIOE,PIN13,GPIO_Mode_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU); //PC13设置输出
	GPIOE->ODR=1<<13;      
