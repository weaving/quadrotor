...
extern u8 FLAG_ATT;
extern T_int16_xyz 		Acc,Gyr;	//á?′?×?o?oóμ?′??D?÷êy?Y
extern T_float_angle 	Att_Angle;	//ATToˉêy????3?μ?×?ì???
extern vs32				Alt;
extern T_RC_Data 		Rc_D;		//ò￡??í¨μàêy?Y
extern T_RC_Control		Rc_C;		//ò￡??1|?üêy?Y
